...
function logObj(req, res, Buffer, chunks) {
  ...
  if (!requestBodyLength || (requestBodyLength &&
    ...
    obj.requestBodyShort = obj.requestBodyString.slice(0, requestBodyLength) + '...(ONLY ' + requestBodyLength + ' CHARS TO SHOW)';
  }
  if (!responseBodyLength || (responseBodyLength &&
    ...
    obj.responseBodyShort = obj.responseBodyString.slice(0, responseBodyLength) + '...(ONLY ' + responseBodyLength + ' CHARS TO SHOW)';
  }
  return obj;
}
