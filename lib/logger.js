...
function logObj(req, res, Buffer, chunks) {
  ...
  if (!requestBodyLength || (requestBodyLength &&
    ...
    obj.requestBodyShort = obj.requestBodyString.slice(0, requestBodyLength) + '...(SHOW ONLY ' + requestBodyLength + ' CHARS)';
  }
  if (!responseBodyLength || (responseBodyLength &&
    ...
    obj.responseBodyShort = obj.responseBodyString.slice(0, responseBodyLength) + '...(SHOW ONLY ' + responseBodyLength + ' CHARS)';
  }
  return obj;
}
